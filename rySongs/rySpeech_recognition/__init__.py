...
class AudioData(object):
    ...
    def get_flac_data(self, convert_rate = None, convert_width = None):
        ...
        #########
        # ryHack... to hide dos window when run outside program like flac_converter.exe
        #http://stackoverflow.com/questions/7006238/how-do-i-hide-the-console-when-i-use-os-system-or-subprocess-call?noredirect=1&lq=1
        #
        ...
        DETACHED_PROCESS = 0x00000008  # ryHack....
        ...
        creationflags=DETACHED_PROCESS ) # ryHack ....
